  ...
  // --- LÓGICA DE ENVÍO DE EMAIL RESTAURADA (CON PERSONALIZACIÓN) ---
router.post("/send-email", async (req, res) => {
  try {
    ...
    // 🔹 Generamos el HTML del carrito con personalización incluida
    const cartHtml = cart
      .map((item) => {
                ...
                if (key === "logoPreview") {
                  return `
                    <p><strong>Logo:</strong><br>
                      <img src="${value}" alt="Logo personalizado" style="max-height:80px;border:1px solid #ddd;border-radius:4px;">
                    </p>`;
                }
